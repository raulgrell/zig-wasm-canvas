...
export default class WebglJlt extends BaseJtl {
    ...
    uniformMatrix4fv(location_id, is_transpose, xx, xy, xz, x_, yx, yy, yz, y_, zx, zy, zz, z_, _x, _y, _z, __) {
        this.gl.uniformMatrix4fv(this.object_map[location_id], is_transpose,
            xx, xy, xz, x_,
            yx, yy, yz, y_,
            zx, zy, zz, z_,
            _x, _y, _z, __
    ...
    _export_api() {
        return {
            ...
            "uniformMatrix4fv": this.uniformMatrix4fv.bind(this),
            ...
            "drawElements": this.gl.drawElements.bind(this.gl)
        };
    }
}
